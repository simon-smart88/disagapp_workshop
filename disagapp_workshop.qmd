...
- Run an analysis using your own data
...
- y = Σ exp(b0 + b1 X)
```{=html}
<img src="images/disaggregation-schematic.png" width = "700px" height = "170px">
```


## Random effects

- Continuous spatial random effect (random field)

- Discrete independent random effect (for overdispersion)

- Both controlled by hyperparameters.
...
- If you have bought your own data, now you can run your own analysis
- If using USA data, downloading covariates will take a long time
